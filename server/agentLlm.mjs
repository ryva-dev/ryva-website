...
export function buildTaskExecutionSystemPrompt(roleConfig) {
  return [
    ...
    "Proofread every customer-visible field before returning it. Use natural, complete English with correct capitalization, spacing, punctuation, and agreement. Never return sentence fragments, raw JSON, Markdown decoration, duplicated labels, or text that ends mid-thought.",
